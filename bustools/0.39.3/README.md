...
tar xzvf bustools_linux-v0.39.3.tar.gz

## Ignore all downloaded/installed files
echo "bustools*" >> .gitignore
...
Currently Loaded Modules:
  ...
  2) stata/16          5) gcc/4.4.7                       8) git-status-size/github     11) ruby/2.6.4p104  14) conda_R/3.6.x
  3) JHPCE_tools/1.0   6) COMMUNITY_CENTOS7_DEFAULT_ENV   9) git/2.23.0                 12) rmate/1.5.9



$ date
Fri Dec  6 14:27:03 EST 2019
$ echo "User: ${USER}"
User: lcollado
$ echo "Hostname: ${HOSTNAME}"
