...
#   Install nda-tools 0.7.0 and some additional packages we commonly use
pip install nda-tools==0.7.0 pyhere session_info openpyxl
...
$ date
Tue Jun 23 11:20:03 AM EDT 2026
$ echo "User: ${USER}"
User: rmiller
$ echo "Hostname: ${HOSTNAME}"
Hostname: compute-177.cm.cluster
```
