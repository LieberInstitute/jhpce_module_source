...
wget https://github.com/samtools/bcftools/releases/download/1.13/bcftools-1.13.tar.bz2 -O bcftools.tar.bz2 && \
    tar -xjvf bcftools.tar.bz2 && \
    cd bcftools-1.13 && \
    ./configure prefix=/jhpce/shared/jhpce/libd/bcftools/1.13 && \
    make && \
    make install
