...
python -m pip install torch==1.8.2+cu111 torchvision==0.9.2+cu111 \
    torchaudio==0.8.2 -f https://download.pytorch.org/whl/lts/1.8/torch_lts.html

#  Install tensorQTL (latest: 1.0.6, at the time)
git clone git@github.com:broadinstitute/tensorqtl.git
cd tensorqtl
python -m pip install -r install/requirements.txt
python -m pip install tensorqtl==1.0.6
...
chmod -R 775 /jhpce/shared/jhpce/libd/tensorqtl
chmod -R 755 /jhpce/shared/jhpce/libd/tensorqtl/1.0.6/tensorqtl_venv
