...
git clone git@github.com:gpertea/gclib.git
module unload conda_R
cd gclib
make release
cd ..

git clone git@github.com:gpertea/gffread.git
cd gffread
make release
cd ..

## Ignore all downloaded/installed files
echo "gclib" >> .gitignore
echo "gffread" >> .gitignore
